...
public class HotPatch {
    ...
    private static final String TAG = DEBUG ? "HotPatch" : HotPatch.class.getSimpleName();
    ...
    private static HotPatch sInstance;

    public synchronized static HotPatch getInstance() {
        if (null == sInstance) {
            sInstance = new HotPatch();
        }
        return sInstance;
    }
