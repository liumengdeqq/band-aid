...
extern "C" enum ele7en_status registerInlineHook(uint32_t target_addr, uint32_t new_addr, uint32_t **proto_addr);
extern "C" enum ele7en_status inlineUnHook(uint32_t target_addr);
extern "C" void inlineUnHookAll();
extern "C" enum ele7en_status inlineHook(uint32_t target_addr);
extern "C" void inlineHookAll();
